...
/**
 * Runs the "queries" test suite (rex_yform_manager_query builder).
 *
 * @package redaxo\yform
 *
 * @internal
 */
class rex_command_yform_test_queries extends rex_console_command
{
    protected function configure(): void
    {
        $this
            ->setDescription('Runs the rex_yform_manager_query builder test suite')

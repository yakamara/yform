...
/**
 * Runs the "tables" test suite (rex_yform_manager_table_api CRUD).
 *
 * @package redaxo\yform
 *
 * @internal
 */
class rex_command_yform_test_tables extends rex_console_command
{
    protected function configure(): void
    {
        $this
            ->setDescription('Runs the rex_yform_manager_table_api test suite')

...
/**
 * Runs the "table-read" test suite (rex_yform_manager_table read-only API).
 *
 * @package redaxo\yform
 *
 * @internal
 */
class rex_command_yform_test_table_read extends rex_console_command
{
    protected function configure(): void
    {
        $this
            ->setDescription('Runs the rex_yform_manager_table read-only API test suite')

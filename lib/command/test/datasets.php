...
/**
 * Runs the "datasets" test suite (rex_yform_manager_dataset CRUD).
 *
 * @package redaxo\yform
 *
 * @internal
 */
class rex_command_yform_test_datasets extends rex_console_command
{
    protected function configure(): void
    {
        $this
            ->setDescription('Runs the rex_yform_manager_dataset CRUD test suite')

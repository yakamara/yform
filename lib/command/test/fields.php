...
/**
 * Runs the "fields" test suite (rex_yform_manager_field wrapper).
 *
 * @package redaxo\yform
 *
 * @internal
 */
class rex_command_yform_test_fields extends rex_console_command
{
    protected function configure(): void
    {
        $this
            ->setDescription('Runs the rex_yform_manager_field test suite')

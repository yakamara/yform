...
class rex_yform_value_hidden extends rex_yform_value_abstract
{
    public function setValue($value)
    {
        ...
        } elseif ($this->getElement(3) == 'GET' && isset($_GET[$this->getElement(2)])) {
            $this->value = rex_get($this->getElement(2));
        } elseif ($this->getElement(3) == 'POST' && isset($_POST[$this->getElement(2)])) {
            $this->value = rex_post($this->getElement(2));
        } elseif ($this->getElement(3) == 'SESSION' && isset($_SESSION[rex::getProperty('instname')][$this->getElement(2)])) {

...
class rex_yform_list extends rex_list
{
    ...
    function getClassicView()
    {
        ...
        $s .= '<li class="rex-navi-paginate-next"><a href="' . $this->getUrl(array('start' => $start + $rowsPerPage)) . '" title="' . rex_i18n::msg('list_next') . '"><span>' . rex_i18n::msg('list_next') . '</span></a></li>';
    ...
    function getPlainView()
    {
        ...
        $return = '';
        if ($prev !== '') {
            $return .= '<li class="rex-navi-paginate-prev"><a class="rex-active" href="' . $this->getUrl(array('start' => $prev)) . '" title="'.rex_i18n::msg('list_previous').'"><span>' . rex_i18n::msg('list_previous') . '</span></a></li>';
        } else {
        ...
        if ($next !== '') {
            $return .= '<li class="rex-navi-paginate-next"><a class="rex-active" href="' . $this->getUrl(array('start' => $next)) . '" title="' . rex_i18n::msg('list_next') . '"><span>' . rex_i18n::msg('list_next') . '</span></a></li>';
        } else {
    ...
    */
    ...
    function getSingleView($params = array())
    {
        ...
        $return .= '<ul class="navi-header"><li class="first"><a class="back" href="' . $this->getUrl(array_merge($params, array('list_style' => 'line', 'start' => 0))) . '">'.rex_i18n::msg('yform_back_to_overview').'</a></li></ul>';

    ...
    function getDefinitions()
    {
        return array(
            ...
            'values' => array(
                ...
                'ignore_offlines' => array( 'type' => 'boolean', 'label' => rex_i18n::msg("yform_values_be_select_media_category_ignore_offlines"), 'default' => 1),
                'check_perms'     => array( 'type' => 'boolean', 'label' => rex_i18n::msg("yform_values_be_select_media_category_check_perms"), 'default' => 1),
                'homepage'        => array( 'type' => 'boolean', 'label' => rex_i18n::msg("yform_values_be_select_media_category_homepage"), 'default' => 1),
                'category' => array( 'type' => 'text',    'label' => rex_i18n::msg("yform_values_be_select_media_category_category"), 'value' => 0),
                'clang'    => array( 'type' => 'select_sql',    'query' => 'select id, code as name from rex_clang', 'label' => rex_i18n::msg("yform_values_be_select_media_category_clang"), 'value' => 1),

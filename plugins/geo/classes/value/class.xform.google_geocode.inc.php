...
class rex_yform_google_geocode extends rex_yform_value_abstract
{
    ...
    function enterObject()
    {
        ...
        if (!defined('REX_yform_GOOGLE_GEOCODE_JSCRIPT')) {
            define('REX_yform_GOOGLE_GEOCODE_JSCRIPT', true);

...
/**
 * Runs the "field-types" test suite.
 *
 * @package redaxo\yform
 *
 * @internal
 */
#[AsCommand(name: 'yform:test:field-types')]
class TestFieldTypesCommand extends AbstractCommand
{
    protected function configure(): void
    {
        $this
            ->setDescription('Runs the YForm field-types behavior test suite')

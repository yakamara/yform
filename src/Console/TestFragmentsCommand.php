...
/**
 * Runs the "fragments" test suite.
 *
 * @package redaxo\yform
 *
 * @internal
 */
#[AsCommand(name: 'yform:test:fragments')]
class TestFragmentsCommand extends AbstractCommand
{
    protected function configure(): void
    {
        $this
            ->setDescription('Runs the YForm fragment test suite')

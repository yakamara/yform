...
/**
 * Runs the "backend-pages" test suite.
 *
 * @package redaxo\yform
 *
 * @internal
 */
#[AsCommand(name: 'yform:test:backend-pages')]
class TestBackendPagesCommand extends AbstractCommand
{
    protected function configure(): void
    {
        $this
            ->setDescription('Runs the YForm backend page test suite')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $result = $runner->run('backend-pages', [

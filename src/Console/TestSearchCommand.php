...
/**
 * Runs the "search" test suite.
 *
 * @package redaxo\yform
 *
 * @internal
 */
#[AsCommand(name: 'yform:test:search')]
class TestSearchCommand extends AbstractCommand
{
    protected function configure(): void
    {
        $this
            ->setDescription('Runs the YForm search test suite')

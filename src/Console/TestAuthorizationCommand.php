...
/**
 * Runs the "authorization" test suite.
 *
 * @package redaxo\yform
 *
 * @internal
 */
#[AsCommand(name: 'yform:test:authorization')]
class TestAuthorizationCommand extends AbstractCommand
{
    protected function configure(): void
    {
        $this
            ->setDescription('Runs the YForm authorization test suite')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $result = $runner->run('authorization', [

...
/**
 * Runs the "table-read" test suite (Table read-only API).
 *
 * @package redaxo\yform
 *
 * @internal
 */
#[AsCommand(name: 'yform:test:table-read')]
class TestTableReadCommand extends AbstractCommand
{
    protected function configure(): void
    {
        $this
            ->setDescription('Runs the Table read-only API test suite')

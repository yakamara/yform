...
/**
 * Runs the "extension-points" test suite.
 *
 * @package redaxo\yform
 *
 * @internal
 */
#[AsCommand(name: 'yform:test:extension-points')]
class TestExtensionPointsCommand extends AbstractCommand
{
    protected function configure(): void
    {
        $this
            ->setDescription('Runs the YForm extension-points test suite')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $result = $runner->run('extension-points', [

...
class CustomFunction extends AbstractValidate
{
    ...
    public function getDefinitions(): array
    {
        return [
            ...
            'name' => 'customfunction',
            'values' => [
                'name' => ['type' => 'select_names', 'label' => I18n::msg('yform_validate_customfunction_name')],
                'function' => ['type' => 'text',  'label' => I18n::msg('yform_validate_customfunction_function')],
                'params' => ['type' => 'text',   'label' => I18n::msg('yform_validate_customfunction_params')],
                'message' => ['type' => 'text',   'label' => I18n::msg('yform_validate_customfunction_message')],
                'validate_type' => ['type' => 'choice',   'label' => I18n::msg('yform_validate_customfunction_type'), 'choices' => ['normal', 'pre', 'post'], 'default' => 'normal'],
            ],
            'description' => I18n::msg('yform_validate_customfunction_description'),
            'multi_edit' => false,
        ];
    }
}

...
class Type extends AbstractValidate
{
    ...
    {
        return 'validate|type|name|int/float/numeric/string/email/url/date/datetime/hex/iban/json|warning_message|[1=' . I18n::msg('yform_validate_type_not_required') . ']';
    }
    ...
    public function getDefinitions(): array
    {
        return [
            ...
            'name' => 'type',
            'values' => [
                'name' => ['type' => 'select_name', 'label' => I18n::msg('yform_validate_type_name')],
                'type' => ['type' => 'choice',    'label' => I18n::msg('yform_validate_type_type'), 'choices' => 'int,float,numeric,string,email,url,time,date,datetime,hex,iban,json'],
                'message' => ['type' => 'text',    'label' => I18n::msg('yform_validate_type_message')],
                'not_required' => ['type' => 'boolean',    'label' => I18n::msg('yform_validate_type_not_required'), 'default' => 0],
            ],
            'description' => I18n::msg('yform_validate_type_description'),
            'famous' => true,
        ];
    }
}

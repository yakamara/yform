...
class Unique extends AbstractValidate
{
    ...
    public function getDefinitions(): array
    {
        return [
            ...
            'name' => 'unique',
            'values' => [
                'name' => ['type' => 'text',       'label' => I18n::msg('yform_validate_unique_name'), 'notice' => I18n::msg('yform_validate_unique_notice')],
                'message' => ['type' => 'text',      'label' => I18n::msg('yform_validate_unique_message')],
                'table' => ['type' => 'text',      'label' => I18n::msg('yform_validate_unique_table')],
                'empty_option' => ['type' => 'boolean', 'label' => I18n::msg('yform_validate_unique_empty_option')],
            ],
            'description' => I18n::msg('yform_validate_unique_description'),
            'multi_edit' => false,
        ];
    }
}

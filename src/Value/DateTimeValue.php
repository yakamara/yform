...
class DateTimeValue extends AbstractValue
{
    ...
    public function enterObject()
    {
        ...
        if ($this->saveInDb()) {
            $sqlValue = $this->getValue();
            $this->params['value_pool']['sql'][$this->getName()] = '0000-00-00 00:00:00' === $sqlValue ? null : ($sqlValue ?: null);
        }
        ...
        if (!$this->isEditable()) {
            $this->params['form_output'][$this->getId()] = $this->parse(
                ['value.datetime-view.tpl.php', 'value.date-view.tpl.php', 'view'],
    ...
    public function getDefinitions(): array
    {
        return [
            ...
            'values' => [
                ...
                'year_start' => ['type' => 'text', 'label' => I18n::msg('yform_values_datetime_year_start')],
                'year_end' => ['type' => 'text', 'label' => I18n::msg('yform_values_datetime_year_end')],
                'format' => ['type' => 'choice', 'label' => I18n::msg('yform_values_datetime_format'), 'choices' => self::VALUE_DATETIME_FORMATS, 'default' => self::VALUE_DATETIME_DEFAULT_FORMAT, 'notice' => I18n::msg('yform_values_format_show_notice')],
                'current_date' => ['type' => 'boolean', 'label' => I18n::msg('yform_values_datetime_current_date')],
                'no_db' => ['type' => 'no_db', 'label' => I18n::msg('yform_values_defaults_table'),  'default' => 0],
                'widget' => ['type' => 'choice', 'label' => I18n::msg('yform_values_defaults_widgets'), 'choices' => ['select' => 'select', 'input:text' => 'input:text'], 'default' => 'select'],
    ...
    public static function getSearchField($params)
    {
        ...
        $params['searchForm']->setValueField('text', [
            ...
            'notice' => I18n::msg('yform_values_date_search_notice', $format),

...
class Time extends AbstractValue
{
    ...
    public function enterObject()
    {
        ...
        if ($this->saveInDb()) {
            ...
            $this->params['value_pool']['sql'][$this->getName()] = '' === $sqlValue ? null : $sqlValue;
        }
    ...
    public function getDefinitions(): array
    {
        return [
            ...
            'values' => [
                ...
                'format' => ['type' => 'choice',    'label' => I18n::msg('yform_values_time_format'), 'choices' => self::VALUE_TIME_FORMATS, 'notice' => I18n::msg('yform_values_format_show_notice')],
                'current_time' => ['type' => 'boolean', 'label' => I18n::msg('yform_values_time_current_time')],
            ...
            'description' => I18n::msg('yform_values_time_description'),
            'db_type' => ['time'],
        ];
    }

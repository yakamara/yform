    ...
    public function getDefinitions(): array
    {
        return [
            ...
            'values' => [
                ...
                'names' => ['type' => 'text',  'label' => I18n::msg('yform_values_index_names'), 'notice' => I18n::msg('yform_values_index_names_notice')],
                'no_db' => ['type' => 'no_db',   'label' => I18n::msg('yform_values_defaults_table'),  'default' => 0],
                'function' => ['type' => 'text',  'label' => I18n::msg('yform_values_index_function'), 'notice' => I18n::msg('yform_values_index_function_notice')],
                'add_this_param' => ['type' => 'checkbox',   'label' => I18n::msg('yform_values_index_add_this_param'),  'default' => 0],
                'salt' => ['type' => 'text',    'label' => I18n::msg('yform_values_hashvalue_salt')],
            ],
            'description' => I18n::msg('yform_values_index_description'),

...
class Date extends AbstractValue
{
    ...
    public function enterObject()
    {
        ...
        if ($this->saveInDb()) {
            ...
            $this->params['value_pool']['sql'][$this->getName()] = '0000-00-00' === $sqlValue ? null : ($sqlValue ?? null);
        }
        ...
        if (!$this->isEditable()) {
            $this->params['form_output'][$this->getId()] = $this->parse(
                ['value.date-view.tpl.php', 'value.datetime-view.tpl.php', 'view'],
    ...
    public function getDefinitions(): array
    {
        return [
            ...
            'values' => [
                ...
                'year_start' => ['type' => 'text', 'label' => I18n::msg('yform_values_date_year_start')],
                'year_end' => ['type' => 'text', 'label' => I18n::msg('yform_values_date_year_end')],
                'format' => ['type' => 'choice', 'label' => I18n::msg('yform_values_date_format'), 'choices' => self::VALUE_DATE_FORMATS, 'default' => self::VALUE_DATE_DEFAULT_FORMAT, 'notice' => I18n::msg('yform_values_format_show_notice')],
                'current_date' => ['type' => 'boolean', 'label' => I18n::msg('yform_values_date_current_date')],
                'no_db' => ['type' => 'no_db',   'label' => I18n::msg('yform_values_defaults_table')],
                'widget' => ['type' => 'choice', 'label' => I18n::msg('yform_values_defaults_widgets'), 'choices' => ['select' => 'select', 'input:text' => 'input:text', 'input:date' => 'input:date'], 'default' => 'select'],
            ...
            'description' => I18n::msg('yform_values_date_description'),
            'db_type' => ['date'],
            'famous' => true,
        ];
    }

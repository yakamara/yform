...
class Field implements ArrayAccess
{
    ...
    {
        $class = 0 == count($values)
            ? null
            : FieldRegistry::getClass($values['type_id'], $values['type_name']);

        if (null === $class) {
            throw new Exception(I18n::msg('yform_field_not_found'));
        }
    ...
    {
        return Core::getTablePrefix() . 'yform_field';
    }
    ...
    /**
     * @return null|mixed|AbstractValidate|AbstractValue
     */
    ...
    {
        return I18n::translate($this->values['label'] ?? '');
    }

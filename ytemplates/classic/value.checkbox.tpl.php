...
<p class="formcheckbox formlabel-<?php echo $this->getName() ?>" id="<?php echo $this->getHTMLId() ?>">
    <input type="checkbox" class="checkbox<?php echo $this->getWarningClass() ?>" name="<?php echo $this->getFieldName() ?>" id="<?php echo $this->getFieldId() ?>" value="1"<?php echo 1 == $this->getValue() ? ' checked="checked"' : '' ?> />
